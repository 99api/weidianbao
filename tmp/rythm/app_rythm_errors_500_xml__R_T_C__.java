...
public class app_rythm_errors_500_xml__R_T_C__ extends com.greenlaw110.rythm.template.TagBase {
   ...
   protected String _url(boolean isAbsolute, String action, Object... params) {
	...
	@Override public com.greenlaw110.rythm.utils.TextBuilder build(){
		out().ensureCapacity(193);
p("<error>\n<type>"); //line: 6

try{pe((null == exception ? "" : exception.getClass().getName()));} catch (RuntimeException e) {handleTemplateExecutionException(e);}  //line: 3
p("</type>\n<message>"); //line: 6

try{pe((null == exception ? "" : exception.getMessage()));} catch (RuntimeException e) {handleTemplateExecutionException(e);}  //line: 4
p("</message>\n</error>"); //line: 6
