...
public class app_rythm_errors_404_txt__R_T_C__ extends com.greenlaw110.rythm.template.TagBase {
   ...
   protected String _url(boolean isAbsolute, String action, Object... params) {
	...
	@Override public com.greenlaw110.rythm.utils.TextBuilder build(){
		out().ensureCapacity(55);
p("Not found"); //line: 5

try{pe(result.getMessage());} catch (RuntimeException e) {handleTemplateExecutionException(e);}  //line: 4
