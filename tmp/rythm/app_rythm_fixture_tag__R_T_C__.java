...
public class app_rythm_fixture_tag__R_T_C__ extends com.greenlaw110.rythm.template.TagBase {
	...
	@Override protected void setup() {
		...
		if (delete == null) {delete=(Object)_get("delete");}
		if (load == null) {load=(String)_get("load");}
	...
	protected Object delete=null; //line: 2
	protected String load=null; //line: 2
	...
	@SuppressWarnings("unchecked") public void setRenderArgs(java.util.Map<String, Object> args) {
		...
		if (null != args && args.containsKey("delete")) this.delete=(Object)args.get("delete");
		if (null != args && args.containsKey("load")) this.load=(String)args.get("load");
	...
	@SuppressWarnings("unchecked") public void setRenderArgs(Object... args) {
		...
		if (_p < l) { Object v = args[_p++]; boolean isString = ("java.lang.String".equals("Object") || "String".equals("Object")); delete = (Object)(isString ? (null == v ? "" : v.toString()) : v); }
		if (_p < l) { Object v = args[_p++]; boolean isString = ("java.lang.String".equals("String") || "String".equals("String")); load = (String)(isString ? (null == v ? "" : v.toString()) : v); }
	}
	...
	@SuppressWarnings("unchecked") @Override public void setRenderArg(String name, Object arg) {
		...
		if ("delete".equals(name)) this.delete=(Object)arg;
		if ("load".equals(name)) this.load=(String)arg;
	...
	@SuppressWarnings("unchecked") public void setRenderArg(int pos, Object arg) {
		...
		if (_p++ == pos) { Object v = arg; boolean isString = ("java.lang.String".equals("Object") || "String".equals("Object")); delete = (Object)(isString ? (null == v ? "" : v.toString()) : v); }
		if (_p++ == pos) { Object v = arg; boolean isString = ("java.lang.String".equals("String") || "String".equals("String")); load = (String)(isString ? (null == v ? "" : v.toString()) : v); }
   ...
   protected String _url(boolean isAbsolute, String action, Object... params) {
	...
	@Override public com.greenlaw110.rythm.utils.TextBuilder build(){
		out().ensureCapacity(1345);
 //line: 3
    if ("all".equals(delete)) { //line: 4
        Fixtures.deleteAll(); //line: 5
    } else if (delete instanceof Model) { //line: 6
        //Fixtures.delete((Model)delete); //line: 7
        throw new RuntimeException("delete a specific model not supported yet"); //line: 8
    } //line: 9
    if (null != load) { //line: 10
        Fixtures.load(load); //line: 11
    } //line: 12
    if (null != arg) { //line: 13
        try { //line: 14
            Play.classloader.loadClass(arg).newInstance(); //line: 15
        } catch (Exception e) { //line: 16
            throw new TagInternalException("Cannot apply " + arg + " fixture because of " + e.getClass().getName() + ", " + e.getMessage()); //line: 17
        } //line: 18
    } //line: 19
; //line: 24
