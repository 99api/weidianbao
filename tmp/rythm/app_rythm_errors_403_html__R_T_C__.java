...
public class app_rythm_errors_403_html__R_T_C__ extends com.greenlaw110.rythm.template.TagBase {
   ...
   protected String _url(boolean isAbsolute, String action, Object... params) {
	...
	@Override public com.greenlaw110.rythm.utils.TextBuilder build(){
		out().ensureCapacity(53);
p("<h1>"); //line: 2

try{pe(result.getMessage());} catch (RuntimeException e) {handleTemplateExecutionException(e);}  //line: 2
p("</h1>"); //line: 2
