...
public class app_rythm_errors_404_html__R_T_C__ extends com.greenlaw110.rythm.template.TagBase {
	...
	@Override protected void setup() {
		if (result == null) {result=(Exception)_get("result");}
	...
	protected Exception result=null; //line: 2
	...
	@SuppressWarnings("unchecked") public void setRenderArgs(java.util.Map<String, Object> args) {
		if (null != args && args.containsKey("result")) this.result=(Exception)args.get("result");
	...
	@SuppressWarnings("unchecked") public void setRenderArgs(Object... args) {
		...
		if (_p < l) { Object v = args[_p++]; boolean isString = ("java.lang.String".equals("Exception") || "String".equals("Exception")); result = (Exception)(isString ? (null == v ? "" : v.toString()) : v); }
	}

	@SuppressWarnings("unchecked") @Override public void setRenderArg(String name, Object arg) {
		if ("result".equals(name)) this.result=(Exception)arg;
	...
	@SuppressWarnings("unchecked") public void setRenderArg(int pos, Object arg) {
		int _p = 0;
		if (_p++ == pos) { Object v = arg; boolean isString = ("java.lang.String".equals("Exception") || "String".equals("Exception")); result = (Exception)(isString ? (null == v ? "" : v.toString()) : v); }
   ...
   protected String _url(boolean isAbsolute, String action, Object... params) {
	...
	@Override public com.greenlaw110.rythm.utils.TextBuilder build(){
		out().ensureCapacity(427);
p("<!DOCTYPE html>"); //line: 20
p("<html>\n<head>\n<title>Not found</title>\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset="); //line: 20

try{pe(_response_encoding);} catch (RuntimeException e) {handleTemplateExecutionException(e);}  //line: 7
p("\"/>\n</head>\n<body>\n "); //line: 20
if ("DEV".equals(_play.mode.name())) { //line: 10
p("\n "); //line: 20
{ //line: 11
	com.greenlaw110.rythm.runtime.ITag.ParameterList _pl = null;  //line: 11
	_pl = new com.greenlaw110.rythm.runtime.ITag.ParameterList(); //line: 11
	_pl.add("",result); //line: 11
		_invokeTag("e404", _pl, false); //line: 11
} //line: 11
p("\n "); //line: 20
}else { //line: 12
p("\n<h1>Not found</h1>\n<p>\n "); //line: 20

try{pe(result.getMessage());} catch (RuntimeException e) {handleTemplateExecutionException(e);}  //line: 15
p("\n</p>\n "); //line: 20
} //line: 17
p("\n</body>\n</html>"); //line: 20
